                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="ktp_number" class="col-md-4 col-form-label text-md-right">{{ __('KTP Number') }}</label>
                                <div class="col-md-6">
                                    <input id="ktp_number" type="text" class="form-control{{ $errors->has('ktp_number') ? ' is-invalid' : '' }}" name="ktp_number" value="{{ old('ktp_number') }}" required>
                            ...
                            <div class="form-group row">
                                <label for="ktp_photo" class="col-md-4 col-form-label text-md-right">{{ __('KTP Photo') }}</label>
                                <div class="col-md-6">
                                    <input id="ktp_photo" type="file" class="form-control{{ $errors->has('ktp_photo') ? ' is-invalid' : '' }}" name="ktp_photo" required>
